...
export default function ConversationShell({
  ...
  const resolvedTopBar =
    topRightTool || isWindow ? (
      <ConversationShellTopBar isWindow={isWindow} leftPaneOpen={leftPaneOpen} leading={chrome?.titleLeading}>
        {topBar}
...
type TopBarProps = { isWindow: boolean; leftPaneOpen: boolean; leading?: ReactNode; children?: ReactNode }

const ConversationShellTopBar = ({ isWindow, leftPaneOpen, leading, children }: TopBarProps) => {
