    ...
    <NarrowLayout narrowMode={narrowMode} style={{ width: '100%' }}>
      <div
        ...
        <div
          id="inputbar"
          className={cn(
            'inputbar-container relative mb-3 rounded-[17px] border-(--color-border) border-[0.5px] bg-(--color-background-opacity) pt-2 transition-all duration-200 ease-in-out [[navbar-position=top]_&]:mb-3.5',
            isDragging &&
