 ...
 * Generated at: 2026-06-01T11:35:25.537Z
 *
...
export interface PreferenceSchemas {
  default: {
    ...
    'shortcut.topic.toggle_left_sidebar': PreferenceTypes.PreferenceShortcutType
    // redux/shortcuts/shortcuts.toggle_show_topics
    'shortcut.topic.toggle_right_sidebar': PreferenceTypes.PreferenceShortcutType
...
export const DefaultPreferences: PreferenceSchemas = {
  default: {
    ...
    'shortcut.topic.toggle_left_sidebar': { binding: ['CommandOrControl', '['], enabled: true },
    'shortcut.topic.toggle_right_sidebar': { binding: ['CommandOrControl', ']'], enabled: true },
