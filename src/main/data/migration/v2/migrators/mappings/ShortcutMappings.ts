...
const LEGACY_KEY_TO_TARGET_KEY: Record<string, string> = {
  ...
  toggle_show_topics: 'shortcut.topic.toggle_right_sidebar',
  toggle_show_assistants: 'shortcut.topic.toggle_left_sidebar',
  toggle_sidebar: 'shortcut.topic.toggle_left_sidebar',
