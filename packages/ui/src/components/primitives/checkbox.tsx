...
const checkboxVariants = cva(
  cn(
    ...
    'motion-reduce:animate-none motion-reduce:hover:scale-100 motion-reduce:active:scale-100',
...
const checkboxIconVariants = cva('animate-checkbox-icon-in dark:text-white motion-reduce:animate-none', {
  variants: {
    size: {
      sm: 'size-3',
      md: 'size-3.5',
