...
const WorkersAiMono: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg width="1em" height="1em" viewBox="0 1 16 14" {...props}>
    <path
      fill="currentColor"
...
export { WorkersAiMono }
export default WorkersAiMono
