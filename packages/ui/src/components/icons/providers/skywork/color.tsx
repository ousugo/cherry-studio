...
const Skywork: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 80 80" {...props}>
    <path
      fill="#4D5EFF"
      d="M43.884 12.7518C35.413 6.13959 23.1656 6.36227 14.9174 13.8152C5.67392 22.1589 4.95134 36.4195 13.2996 45.6584C20.7525 53.9067 32.9136 55.37 42.0116 49.653L24.4972 30.2663L43.884 12.7518Z"
    />
    <path
      fill="#00FFCE"
