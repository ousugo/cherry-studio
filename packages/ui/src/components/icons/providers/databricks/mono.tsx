...
const DatabricksMono: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 300 331" {...props}>
    <path
      fill="currentColor"
...
export { DatabricksMono }
export default DatabricksMono
