...
const Sora: IconComponent = (props: SVGProps<SVGSVGElement>) => (
  <svg
    ...
    />
    <path fill="url(#sora__b)" d="M9.726 11.36a.306.306 0 110 .612.306.306 0 010-.612z" />
    <path
      fill="url(#sora__c)"
      fillRule="evenodd"
      ...
      clipRule="evenodd"
    />
    <path fill="url(#sora__d)" d="M14.87 9.982a.307.307 0 110 .613.307.307 0 010-.613z" />
    <path
      fill="url(#sora__e)"
      fillRule="evenodd"
    ...
    />
    <defs>
      <linearGradient id="sora__a" x1={12} x2={12} y1={0} y2={24} gradientUnits="userSpaceOnUse">
        <stop stopColor="#012659" />
        <stop offset={1} stopColor="#0968DA" />
      </linearGradient>
      <linearGradient id="sora__b" x1={9.859} x2={14.219} y1={3} y2={21.017} gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset={1} stopColor="#6BB6FE" />
      </linearGradient>
      <linearGradient id="sora__c" x1={9.859} x2={14.219} y1={3} y2={21.017} gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset={1} stopColor="#6BB6FE" />
      </linearGradient>
      <linearGradient id="sora__d" x1={9.859} x2={14.219} y1={3} y2={21.017} gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset={1} stopColor="#6BB6FE" />
      </linearGradient>
      <linearGradient id="sora__e" x1={9.859} x2={14.219} y1={3} y2={21.017} gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset={1} stopColor="#6BB6FE" />
      </linearGradient>
      <linearGradient id="sora__f" x1={9.859} x2={14.219} y1={3} y2={21.017} gradientUnits="userSpaceOnUse">
        <stop stopColor="#fff" />
        <stop offset={1} stopColor="#6BB6FE" />
      </linearGradient>
    </defs>
