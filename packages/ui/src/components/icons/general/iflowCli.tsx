...
const IflowCli = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" fill="none" viewBox="0 0 120 120" {...props}>
    <g clipPath="url(#iflowcli__a)">
      <path
        fill="url(#iflowcli__b)"
    ...
    <defs>
      <linearGradient id="iflowcli__b" x1={101.041} x2={33.649} y1={4.814} y2={77.575} gradientUnits="userSpaceOnUse">
        <stop offset={0.32} stopColor="#A25CFF" />
        <stop offset={1} stopColor="#2B52F0" />
      </linearGradient>
      <linearGradient id="iflowcli__c" x1={96.226} x2={17.613} y1={9.938} y2={82.752} gradientUnits="userSpaceOnUse">
        <stop offset={0.32} stopColor="#A25CFF" />
        <stop offset={1} stopColor="#2B52F0" />
      </linearGradient>
      <linearGradient id="iflowcli__d" x1={106.452} x2={27.84} y1={20.979} y2={93.792} gradientUnits="userSpaceOnUse">
        <stop offset={0.32} stopColor="#A25CFF" />
        <stop offset={1} stopColor="#2B52F0" />
      </linearGradient>
      <linearGradient id="iflowcli__e" x1={111.215} x2={50.508} y1={30.977} y2={87.205} gradientUnits="userSpaceOnUse">
        <stop offset={0.32} stopColor="#A25CFF" />
        <stop offset={1} stopColor="#2B52F0" />
      </linearGradient>
      <clipPath id="iflowcli__a">
