...
INSERT INTO `__new_agent_workspace`("id", "name", "path", "order_key", "created_at", "updated_at") SELECT "id", "name", "path", "order_key", "created_at", "updated_at" FROM `agent_workspace`;--> statement-breakpoint
